...
// Site de origem: http://www.java2s.com/Code/Java/Development-Class/AJavaimplementationoftheMT19937MersenneTwisterpseudorandomnumbergeneratoralgorithm.htm
...
public class Random_MT19937
{
   ...
   *
   */
  public static float drand() // get random number from 0 to 1
  //public static float get() // get random number from 0 to 1
  {
      //System.out.println("numero aleatorio = " + rnd.nextFloat());
   ...
   */
  public static int urandom(int n) // Compativel com o método #define urandom(num) (urand() % (num) ) do PROGRAMA DA PATRICIA
   ...
   * @return value
   */
  public static int irand(int min, int max) // Compativel com o método #define irand(a,b) (a + urandom(b) - (a)) do PROGRAMA DA PATRICIA
...
/* double */
    public double drands()
    {
         // unsigned long a=urand()>>5, b=urand()>>6; // Linha do código da PATRICIA
	 long a=rnd.next(52)>>5;
         long b=rnd.next(52)>>6;
//         System.out.println("a = "+a);
//         System.out.println("b = "+b);
//         System.out.println((a*67108864.0+b)*(1.0/9007199254740992.0));
...
class MTRandom extends Random
{
   ...
   */
  @Override
  protected final synchronized int next(int bits)       // No código da PATRICIA esse método é chamado de urand(void)
  {
    // ---- Begin Mersenne Twister Algorithm ----
    int y, kk;
    if (mti >= N)
    { // generate N words at one time
      ...
      // compatible behaviour.
        ...
        /*
        Gera N palavras de uma só vez

        Na implementação do C original, mti é verificada aqui para determinar se a inicialização ocorreu,
        se não ele inicializa essa instância com DEFAULT_SEED (5489).
        Isso não é mais necessário, como a inicialização da instância do Java
        deve resultar na inicialização ocorrendo Use o construtor MTRandom (true)
        para ativar o comportamento compatível.
        */
