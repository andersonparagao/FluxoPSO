...
public class SimulacaoOperacaoEnergeticaPSO {
    ...
    /**
     *
     * Método que define do Sistema Elétrico da Simulação, ou seja, define quais
     * usinas participarão do caso teste.
     *
    ...
    /**
     *
     * Método que define Horizonte de Planejamento, ou seja, define quantos
     * meses serão utilziados na simulação.
     *
     ...
     * @param paramDiscretizacao qual a discretização do horizonte de
     * planejamento
     * @param paramTipo ??????
    ...
    /**
     *
     * Método que define os volumes finais em cada período do horizonte de
     * planejamento.
     *
    ...
    /**
     *
     * Método que define as vazões defluentes em cada período do horizonte de
     * planejamento.
     *
    ...
    /**
     *
     * Método que define as vazões afluentes naturais das usinas em cada período
     ...
     *
     * @param restricaoVolume restrições dos volumes máximo e mínimo de cada
     * usina
     * @param j ?????????????????
     * @param limitesDefluencia restrições das vazões defluentes máxima e mínima
     * de cada usina
...
//	}
    ...
    //metodo de simula��o da gera��o com o PSO
    public double simularOperacaoEnergeticaPSOFinal(int numIntervalos) {
        double geracao = 0;
        double custo = 0;
        System.out.println("");
        for (int i = 0; i < numIntervalos; i++) {
